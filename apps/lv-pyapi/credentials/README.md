...
To enable Text-to-Speech (TTS) and Speech-to-Text (STT) features, you need to set up the `GOOGLE_APPLICATION_CREDENTIALS`.
...
This will enable the voice interface features.
