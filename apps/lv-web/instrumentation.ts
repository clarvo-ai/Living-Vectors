export async function register() {
  // Only skip Edge. In Next 15 standalone / Cloud Run, NEXT_RUNTIME is often unset here;
  // requiring === 'nodejs' prevented the OTel SDK from ever starting (no lv-web traces/logs/metrics).
